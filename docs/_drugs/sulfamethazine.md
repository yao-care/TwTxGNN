...
**APA 格式：**
```
TwTxGNN. (2026). Sulfamethazine老藥新用驗證報告. https://twtxgnn.yao.care/drugs/sulfamethazine/
```

**BibTeX 格式：**
```bibtex
@misc{twtxgnn_sulfamethazine,
  title = {Sulfamethazine老藥新用驗證報告},
  author = {TwTxGNN Team},
  year = {2026},
  url = {https://twtxgnn.yao.care/drugs/sulfamethazine/}
}
```
