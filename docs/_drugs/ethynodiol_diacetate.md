...
**APA 格式：**
```
TwTxGNN. (2026). Ethynodiol Diacetate老藥新用驗證報告. https://twtxgnn.yao.care/drugs/ethynodiol_diacetate/
```

**BibTeX 格式：**
```bibtex
@misc{twtxgnn_ethynodiol_diacetate,
  title = {Ethynodiol Diacetate老藥新用驗證報告},
  author = {TwTxGNN Team},
  year = {2026},
  url = {https://twtxgnn.yao.care/drugs/ethynodiol_diacetate/}
}
```
