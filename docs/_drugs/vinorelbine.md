...
<p class="key-answer" data-question="Vinorelbine 可以用於治療什麼新適應症？">
...
<summary>
<span class="indication-name">2. fibromatosis, gingival</span>
...
<details class="indication-section">
<summary>
<span class="indication-name">3. fibroma of lung</span>
<span class="evidence-badge evidence-L5">L5</span>
<span class="prediction-score">99.99%</span>
</summary>
<div class="indication-content">
...
**APA 格式：**
```
TwTxGNN. (2026). Vinorelbine老藥新用驗證報告. https://twtxgnn.yao.care/drugs/vinorelbine/
```

**BibTeX 格式：**
```bibtex
@misc{twtxgnn_vinorelbine,
  title = {Vinorelbine老藥新用驗證報告},
  author = {TwTxGNN Team},
  year = {2026},
  url = {https://twtxgnn.yao.care/drugs/vinorelbine/}
}
```
