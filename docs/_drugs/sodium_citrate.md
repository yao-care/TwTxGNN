...
**APA 格式：**
```
TwTxGNN. (2026). Sodium Citrate老藥新用驗證報告. https://twtxgnn.yao.care/drugs/sodium_citrate/
```

**BibTeX 格式：**
```bibtex
@misc{twtxgnn_sodium_citrate,
  title = {Sodium Citrate老藥新用驗證報告},
  author = {TwTxGNN Team},
  year = {2026},
  url = {https://twtxgnn.yao.care/drugs/sodium_citrate/}
}
```
