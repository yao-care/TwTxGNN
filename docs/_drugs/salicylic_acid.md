...
**APA 格式：**
```
TwTxGNN. (2026). Salicylic Acid老藥新用驗證報告. https://twtxgnn.yao.care/drugs/salicylic_acid/
```

**BibTeX 格式：**
```bibtex
@misc{twtxgnn_salicylic_acid,
  title = {Salicylic Acid老藥新用驗證報告},
  author = {TwTxGNN Team},
  year = {2026},
  url = {https://twtxgnn.yao.care/drugs/salicylic_acid/}
}
```
