...
|---------|------|---------|---------|----------|----------------|
| TFDA 許可證 | ✅ | 2026-02-09 | avelumab | 2 | 確認上市狀態 |
| TFDA 仿單（警語/禁忌/劑量） | ✅ | 2026-02-09 | avelumab | 1 | 確認仿單資訊 |
| DDI 資料庫 (Unified DDI) | ✅ | 2026-02-09 | avelumab | 3 | 確認重大 DDI |
| DrugBank (MOA) | ✅ | 2026-02-09 | avelumab | 1 | MOA 資料缺口 |
| ClinicalTrials.gov | ✅ (無結果) | 2026-02-09 | avelumab | 0 | 無臨床試驗支持 |
| PubMed | ✅ (無結果) | 2026-02-09 | avelumab | 0 | 無文獻支持 |
...
|------|-----------|---------|-----------|---------|---------|---------|---------|
| 1 | human herpesvirus 8-related tumor | [Data Gap] | 99.97% | L5 | 暫不建議 | Hold | MOA 缺口 |
| 2 | middle ear neuroendocrine tumor | [Data Gap] | 99.97% | L5 | 暫不建議 | Hold | MOA 缺口 |
| 3 | malignant cutaneous granular cell skin tumor | [Data Gap] | 99.97% | L5 | 暫不建議 | Hold | MOA 缺口 |
...
**已執行的查詢**：
1. Unified DDI 資料庫（DDInter + Guide to PHARMACOLOGY）：完成，3 筆重大 DDI
...
| | • 權威藥學資料庫（DDInter/Guide to PHARMACOLOGY/DrugBank）：查詢完成 |
| | • 同儕審查文獻（PubMed/期刊）：未找到 |
| | • 試驗登錄（ClinicalTrials.gov）：未找到 |
| **檢索結果** | 未找到 |
| **推論限制（不能做）** | 不可進行機轉關聯性分析 |
| **風險處置（決策）** | Hold |
| **解鎖條件** | 需要 DrugBank 提供的 MOA 資料 |
...
### 6.3 malignant cutaneous granular cell skin tumor（證據等級: L5）
...
|---|---------|---------|---------|------|-------------|
| 1 | TFDA | 2026-02-09 | avelumab | 2 | [snapshot] |
| 2 | DDI | 2026-02-09 | avelumab | 3 | [snapshot] |
| 3 | DrugBank | 2026-02-09 | avelumab | 1 | [snapshot] |
| 4 | TFDA 仿單 | 2026-02-09 | avelumab | 1 | [snapshot] |
...
| # | 缺口項目 | 推論限制 | 解鎖條件 |
|---|---------|---------|---------|
| 1 | 作用機轉 (MOA) | 影響機轉關聯性分析 | 查詢 DrugBank API 以獲得完整 MOA 資訊 |
...
|---------|------|---------|---------|----------|-------------|
| TFDA 許可證 | ✅ | 2026-02-09 | drug: avelumab | 2 | 無阻斷性影響 |
| TFDA 仿單 | ✅ | 2026-02-09 | drug: avelumab | 1 | 無阻斷性影響 |
| DDI 資料庫 (Unified DDI) | ✅ | 2026-02-09 | drug: avelumab | 3 | 存在重大 DDI |
| DrugBank (MOA) | ✅ | 2026-02-09 | drug: avelumab | 1 | MOA 資訊缺失，影響機轉分析 |
| ClinicalTrials.gov | ✅ (無結果) | 2026-02-09 | drug: avelumab, disease: specific | 0 | 無阻斷性影響 |
| PubMed | ✅ (無結果) | 2026-02-09 | drug: avelumab, disease: specific | 0 | 無阻斷性影響 |
...
|------|-----------|-----------|---------|---------|---------|---------|---------|---------|
| 1 | human herpesvirus 8-related tumor | 99.97% | L5 | 0 項 | [Data Gap] | Hold | Hold | MOA 缺失 |
| 2 | middle ear neuroendocrine tumor | 99.97% | L5 | 0 項 | [Data Gap] | Hold | Hold | MOA 缺失 |
| 3 | malignant cutaneous granular cell skin tumor | 99.97% | L5 | 0 項 | [Data Gap] | Hold | Hold | MOA 缺失 |

**整體開發建議**：目前所有預測適應症均因缺乏直接證據及 MOA 資訊不全而處於 Hold 狀態。需補充作用機轉資料以進一步評估。[來源：DrugBank]
...
|-------|---------|---------|---------|---------|---------|-------------------|
| human herpesvirus 8-related tumor | Hold | Hold | S0 | [Data Gap] | MOA 缺失 | 暫不建議 |
| middle ear neuroendocrine tumor | Hold | Hold | S0 | [Data Gap] | MOA 缺失 | 暫不建議 |
| malignant cutaneous granular cell skin tumor | Hold | Hold | S0 | [Data Gap] | MOA 缺失 | 暫不建議 |

### 整體決策建議
- **最優先開發**：目前無適應症可優先開發，需補充資料
- **次優先開發**：N/A
- **Hold**：所有適應症 — 補件後可升級
- **No-Go**：無

### Top 3 Key Points
1. Avelumab 的作用機轉資料缺失，影響所有預測適應症的機轉關聯性分析。[來源：DrugBank]
2. 預測適應症均無臨床試驗或文獻支持，證據等級為 L5。[來源：ClinicalTrials.gov, PubMed]
3. 存在重大藥物交互作用，需進一步評估安全性風險。[來源：DDInter]

### Top Risks & Mitigation
| 風險類型 | 描述 | 嚴重度 | 緩解措施 |
|---------|------|-------|---------|
| 證據 | 缺乏直接證據支持 | 高 | 補充作用機轉資料 |
| 安全性 | 重大 DDI 可能影響安全性 | 高 | 詳細評估 DDI 風險 |
| 法規 | 缺乏明確的適應症支持 | 中 | 進一步研究以支持適應症 |
...
**已執行的查詢**：
1. Unified DDI 資料庫（DDInter + Guide to PHARMACOLOGY）：已查，回傳 3 筆相關 DDI
...
| **風險處置（決策）** | Hold |
| **解鎖條件** | 查詢 DrugBank API 以獲得完整 MOA 資訊 |

---

## 4. 各適應症詳細評估

### 4.1 human herpesvirus 8-related tumor（L5 完整格式）
...
### 4.2 middle ear neuroendocrine tumor（L5 完整格式）

#### 基本資訊與決策
| 項目 | 內容 |
|------|------|
| 疾病名稱 | middle ear neuroendocrine tumor |
| ICD-10 | [Data Gap] |
| TxGNN 分數 | 99.97% |
| 證據等級 | L5 |
| 建議劑型 | [Data Gap] |
...
### 4.3 malignant cutaneous granular cell skin tumor（L5 完整格式）

#### 基本資訊與決策
| 項目 | 內容 |
|------|------|
| 疾病名稱 | malignant cutaneous granular cell skin tumor |
| ICD-10 | [Data Gap] |
| TxGNN 分數 | 99.97% |
| 證據等級 | L5 |
| 建議劑型 | [Data Gap] |
...
|-------|-----|---------|-----------|---------|---------|-------|
| human herpesvirus 8-related tumor | [Data Gap] | [Data Gap] | 高 | 高 | 不明 | 低 |
| middle ear neuroendocrine tumor | [Data Gap] | [Data Gap] | 高 | 高 | 不明 | 低 |
| malignant cutaneous granular cell skin tumor | [Data Gap] | [Data Gap] | 高 | 高 | 不明 | 低 |

### 5.3 優先開發順序
1. **N/A**：目前無適應症可優先開發，需補充資料
2. **N/A**：N/A
3. **N/A**：N/A
...
| 適應症 | 風險 | 嚴重度 | 緩解措施 |
|-------|-----|-------|---------|
| human herpesvirus 8-related tumor | 缺乏直接證據支持 | 高 | 補充作用機轉資料 |
| middle ear neuroendocrine tumor | 缺乏直接證據支持 | 高 | 補充作用機轉資料 |
| malignant cutaneous granular cell skin tumor | 缺乏直接證據支持 | 高 | 補充作用機轉資料 |

### 6.2 Safety Risk
| 風險 | 影響適應症 | 嚴重度 | 緩解措施 |
|-----|-----------|-------|---------|
| 重大 DDI | 所有適應症 | 高 | 詳細評估 DDI 風險 |
...
|---|-----|-------|---------|-------|-------|------|---------|--------------|
| 1 | MOA 缺失 | 🛑 | DrugBank | 待定 | 待定 | ⏳ | §3 | Conditional Go |
...
| 5 | ClinicalTrials.gov | 2026-02-09 | drug: avelumab, disease: specific | 0 | [snapshot] |
| 6 | PubMed | 2026-02-09 | drug: avelumab, disease: specific | 0 | [snapshot] |
