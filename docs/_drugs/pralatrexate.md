...
其成分在復發或頑固型周邊T細胞淋巴瘤 (PTCL) 中的療效已被證實，機轉上可能適用於胸膜上皮型間皮瘤。
</p>
...
**APA 格式：**
```
TwTxGNN. (2026). Pralatrexate老藥新用驗證報告. https://twtxgnn.yao.care/drugs/pralatrexate/
```

**BibTeX 格式：**
```bibtex
@misc{twtxgnn_pralatrexate,
  title = {Pralatrexate老藥新用驗證報告},
  author = {TwTxGNN Team},
  year = {2026},
  url = {https://twtxgnn.yao.care/drugs/pralatrexate/}
}
```
