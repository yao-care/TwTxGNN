...
|---------|------|---------|---------|----------|----------------|
| TFDA 許可證 | ✅ | 2026-02-09 | {"drug": "pralatrexate"} | 2 | 已上市狀態確認 |
| TFDA 仿單（警語/禁忌/劑量） | ✅ | 2026-02-09 | {"drug": "pralatrexate"} | 1 | 安全性資訊需補充 |
| DDI 資料庫 (Unified DDI) | ✅ | 2026-02-09 | {"drug": "pralatrexate"} | 136 | 存在多項交互作用 |
| DrugBank (MOA) | ✅ | 2026-02-09 | {"drug": "pralatrexate"} | 1 | MOA 資訊缺失 |
...
|------|-----------|---------|-----------|---------|---------|---------|---------|
| 1 | Pleural adenomatoid tumor | [Data Gap] | 99.91% | L5 | 暫不建議 | Hold | 缺乏機轉證據 |
| 2 | Relapsing-remitting multiple sclerosis | [Data Gap] | 99.91% | L5 | 暫不建議 | Hold | 無直接關聯 |
| 3 | Pleural biphasic mesothelioma | [Data Gap] | 99.90% | L5 | 暫不建議 | Hold | 缺乏具體研究 |
...
**已執行的查詢**：
1. Unified DDI 資料庫（DDInter + Guide to PHARMACOLOGY）：136 筆
...
| **缺口項目** | 作用機轉 (MOA) |
| **已完成檢索行動** | |
| | • 官方標籤/主管機關資料（TFDA/FDA/EMA/PMDA）：成功但缺資料 |
| | • 權威藥學資料庫（DDInter/Guide to PHARMACOLOGY/DrugBank）：成功但缺資料 |
| | • 同儕審查文獻（PubMed/期刊）：成功但缺資料 |
| | • 試驗登錄（ClinicalTrials.gov）：成功但缺資料 |
| **檢索結果** | 未找到 |
...
### 6.2 Relapsing-remitting Multiple Sclerosis（證據等級: L5）
...
|------|------|
| TxGNN 分數 | 99.91% |
| 機轉關聯 | Pralatrexate 的作用機轉主要針對快速增殖的細胞，與此適應症的病理機轉無直接關聯 |
...
### 6.3 Pleural Biphasic Mesothelioma（證據等級: L5）
...
|------|------|
| TxGNN 分數 | 99.90% |
| 機轉關聯 | Pralatrexate 通過抑制二氫葉酸還原酶影響細胞增殖，但缺乏針對 pleural biphasic mesothelioma 的具體研究 |
| 關鍵缺口 | 缺乏臨床試驗、機轉研究、安全性資料 |
...
|---|-----|-------|---------|-------|-------|------|---------|
| 1 | 作用機轉 (MOA) | 🛑 | DrugBank | [Data Gap] | [Data Gap] | ⏳ | §5 |
...
| 產生日期 | 2026-02-09 |
| 資料截止日 | 2026-02-09 |
| Evidence Pack 版本 | pralatrexate_v4_2026-02-09.json |
...
| 可支持 | 不可支持 |
|-------|---------|
| Research Question | Go, Conditional Go, Proceed with Guardrails |

### 阻斷性缺口摘要
| # | 缺口項目 | 推論限制 | 解鎖條件 |
|---|---------|---------|---------|
| 1 | 作用機轉 (MOA) | 影響機轉關聯性分析 | 查詢 DrugBank API 取得詳細資料 |
...
|---------|------|---------|---------|----------|-------------|
| TFDA 許可證 | ✅ | 2026-02-09 | {"drug": "pralatrexate"} | 2 | 支持已上市狀態確認 |
| TFDA 仿單 | ✅ | 2026-02-09 | {"drug": "pralatrexate"} | 1 | 支持仿單資料完整性 |
| DDI 資料庫 (Unified DDI) | ✅ | 2026-02-09 | {"drug": "pralatrexate"} | 136 | 影響安全性評估 |
| DrugBank (MOA) | ✅ | 2026-02-09 | {"drug": "pralatrexate"} | 1 | 作用機轉資料缺口 |
| ClinicalTrials.gov | ✅ (無結果) | 2026-02-09 | {"drug": "pralatrexate", "disease": "pleural adenomatoid tumor"} | 0 | 無相關試驗 |
| PubMed | ✅ (無結果) | 2026-02-09 | {"drug": "pralatrexate", "disease": "pleural adenomatoid tumor"} | 0 | 無相關文獻 |
...
|------|-----------|-----------|---------|---------|---------|---------|---------|---------|
| 1 | Pleural adenomatoid tumor | 99.91% | L5 | 0 項 | [Data Gap] | Hold | Hold | 作用機轉資料缺口 |
| 2 | Relapsing-remitting multiple sclerosis | 99.91% | L5 | 0 項 | [Data Gap] | Hold | Hold | 作用機轉資料缺口 |
| 3 | Pleural biphasic mesothelioma | 99.90% | L5 | 0 項 | [Data Gap] | Hold | Hold | 作用機轉資料缺口 |

**整體開發建議**：目前所有預測適應症均處於 Hold 階段，需補齊作用機轉資料以進一步評估。[來源：DrugBank]
...
|-------|---------|---------|---------|---------|---------|-------------------|
| Pleural adenomatoid tumor | Hold | Hold | S0 | TxGNN 高分 | 作用機轉資料缺口 | 待補件後評估 |
| Relapsing-remitting multiple sclerosis | Hold | Hold | S0 | TxGNN 高分 | 作用機轉資料缺口 | 待補件後評估 |
| Pleural biphasic mesothelioma | Hold | Hold | S0 | TxGNN 高分 | 作用機轉資料缺口 | 待補件後評估 |

### 整體決策建議
- **最優先開發**：無，所有適應症均需補件後再評估。
- **次優先開發**：無，所有適應症均需補件後再評估。
- **Hold**：所有適應症 — 需補齊作用機轉資料後可升級。
- **No-Go**：無。

### Top 3 Key Points
1. Pralatrexate 的作用機轉資料缺失，影響新適應症的機轉關聯性分析。[來源：DrugBank]
2. Pralatrexate 已在台灣上市，但缺乏詳細的劑型與許可證資料。[來源：TFDA]
3. 預測的新適應症均未有相關臨床試驗或文獻支持。[來源：ClinicalTrials.gov, PubMed]

### Top Risks & Mitigation
| 風險類型 | 描述 | 嚴重度 | 緩解措施 |
|---------|------|-------|---------|
| 證據 | 作用機轉資料缺失 | 高 | 查詢 DrugBank API 以獲取詳細資料 |
| 安全性 | DDI 風險需進一步評估 | 中 | 進一步分析 DDI 資料庫結果 |
| 法規 | 缺乏完整的許可證資訊 | 中 | 向 TFDA 申請完整資料 |
...
**已執行的查詢**：
1. Unified DDI 資料庫（DDInter + Guide to PHARMACOLOGY）：已查，回傳 136 筆相關 DDI
2. TFDA 仿單「藥物交互作用」章節：仿單未取得
3. DrugBank Interactions：已查，回傳 136 筆相關 DDI
...
**此缺口影響開發建議**：需進一步分析 DDI 資料庫結果以支持進一步開發決策。
...
| **推論限制（不能做）** | 不能進行機轉關聯性分析 |
| **風險處置（決策）** | Hold |
| **解鎖條件** | 需要查詢 DrugBank API 補充詳細作用機轉資料 |
...
| 機轉關聯 | Pralatrexate 是一種葉酸類似物，主要用於抑制癌細胞增殖，但缺乏直接針對 pleural adenomatoid tumor 的機轉證據。 | [Data Gap] |
| 相似度 | [Data Gap] | |
| 類似再利用先例 | 無 | [Data Gap] |
...
| 面向 | 支持外推的理由 | 強度 |
|------|---------------|------|
| 機轉相關性 | Pralatrexate 是葉酸類似物，抑制細胞增殖，與腫瘤生長相關 | 中 |
| 族群相似性 | 無直接證據支持 | 弱 |
| 劑量可行性 | 無劑型資料支持 | 弱 |
...
|-----|-------|---------|-----------|---------|
| 作用機轉資料缺口 | 🛑 | 高 | 不能進行機轉關聯性分析 | 查詢 DrugBank API |
...
|-------|-----|---------|-----------|---------|---------|-------|
| Pleural adenomatoid tumor | [Data Gap] | 中 | 中 | 高 | 不明 | 低 |
| Relapsing-remitting multiple sclerosis | [Data Gap] | 中 | 中 | 高 | 不明 | 低 |
| Pleural biphasic mesothelioma | [Data Gap] | 中 | 中 | 高 | 不明 | 低 |

### 5.3 優先開發順序
1. **Pleural adenomatoid tumor**：需補齊作用機轉資料 [來源：DrugBank]
2. **Relapsing-remitting multiple sclerosis**：需補齊作用機轉資料 [來源：DrugBank]
3. **Pleural biphasic mesothelioma**：需補齊作用機轉資料 [來源：DrugBank]
...
| 適應症 | 風險 | 嚴重度 | 緩解措施 |
|-------|-----|-------|---------|
| Pleural adenomatoid tumor | 作用機轉資料缺失 | 高 | 查詢 DrugBank API 以獲取詳細資料 |

### 6.2 Safety Risk
| 風險 | 影響適應症 | 嚴重度 | 緩解措施 |
|-----|-----------|-------|---------|
| DDI 風險 | 所有適應症 | 中 | 進一步分析 DDI 資料庫結果 |
...
|---|-----|-------|---------|-------|-------|------|---------|--------------|
| 1 | 作用機轉資料缺口 | 🛑 | DrugBank | [負責人] | [截止日] | ⏳ | §3 | Conditional Go |
