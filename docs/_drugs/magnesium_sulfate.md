...
**APA 格式：**
```
TwTxGNN. (2026). Magnesium Sulfate老藥新用驗證報告. https://twtxgnn.yao.care/drugs/magnesium_sulfate/
```

**BibTeX 格式：**
```bibtex
@misc{twtxgnn_magnesium_sulfate,
  title = {Magnesium Sulfate老藥新用驗證報告},
  author = {TwTxGNN Team},
  year = {2026},
  url = {https://twtxgnn.yao.care/drugs/magnesium_sulfate/}
}
```
