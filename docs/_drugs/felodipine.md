...
<p class="key-answer" data-question="Felodipine 可以用於治療什麼新適應症？">
...
### 相關複方製劑
- 含 Felodipine + Enalapril 的複方製劑用於高血壓治療
- 不建議作為起始治療
...
| 交互作用藥物 | 機轉 | 臨床意義 |
|-------------|------|---------|
| CYP3A4 抑制劑 | 代謝減慢 | 血壓過度降低 |
| 葡萄柚汁 | CYP3A4 抑制 | 避免併用 |
| Beta-blockers | 協同降壓 | 可能需要減量 |
| Digoxin | 血中濃度升高 | 監測 digoxin 濃度 |
...
1. 缺乏專門的臨床試驗證據
2. 現有更有效的肺高壓專用藥物
3. Felodipine 對肺血管的選擇性不如其他藥物
4. 惡性高血壓通常需要更積極的介入治療

### 建議行動
- [ ] 對於惡性高血壓，可使用其他更快速作用的降壓藥
- [ ] 肺高壓應由專科醫師使用核准的專門藥物治療
- [ ] 不建議將 felodipine 作為這些適應症的一線選擇

### 特殊情況考量
在無法取得專門肺高壓藥物的緊急情況下，鈣離子通道阻斷劑可能是一個備選，但需要密切監測。

### 風險等級
**高風險** - 不建議超適應症使用於肺高壓；惡性高血壓需要更積極的治療策略
...
**APA 格式：**
```
TwTxGNN. (2026). Felodipine老藥新用驗證報告. https://twtxgnn.yao.care/drugs/felodipine/
```

**BibTeX 格式：**
```bibtex
@misc{twtxgnn_felodipine,
  title = {Felodipine老藥新用驗證報告},
  author = {TwTxGNN Team},
  year = {2026},
  url = {https://twtxgnn.yao.care/drugs/felodipine/}
}
```
