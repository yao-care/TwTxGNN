...
**APA 格式：**
```
TwTxGNN. (2026). Aluminum Oxide老藥新用驗證報告. https://twtxgnn.yao.care/drugs/aluminum_oxide/
```

**BibTeX 格式：**
```bibtex
@misc{twtxgnn_aluminum_oxide,
  title = {Aluminum Oxide老藥新用驗證報告},
  author = {TwTxGNN Team},
  year = {2026},
  url = {https://twtxgnn.yao.care/drugs/aluminum_oxide/}
}
```
