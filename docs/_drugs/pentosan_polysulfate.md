...
**APA 格式：**
```
TwTxGNN. (2026). Pentosan Polysulfate老藥新用驗證報告. https://twtxgnn.yao.care/drugs/pentosan_polysulfate/
```

**BibTeX 格式：**
```bibtex
@misc{twtxgnn_pentosan_polysulfate,
  title = {Pentosan Polysulfate老藥新用驗證報告},
  author = {TwTxGNN Team},
  year = {2026},
  url = {https://twtxgnn.yao.care/drugs/pentosan_polysulfate/}
}
```
