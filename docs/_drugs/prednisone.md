...
**APA 格式：**
```
TwTxGNN. (2026). Prednisone老藥新用驗證報告. https://twtxgnn.yao.care/drugs/prednisone/
```

**BibTeX 格式：**
```bibtex
@misc{twtxgnn_prednisone,
  title = {Prednisone老藥新用驗證報告},
  author = {TwTxGNN Team},
  year = {2026},
  url = {https://twtxgnn.yao.care/drugs/prednisone/}
}
```
